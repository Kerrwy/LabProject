...
addpath('H:\Event-based Vision Resources\Codes\rpg_event_lifetime-master实时代码 - 每个位置LIF\matlab\data\AedatTools-master\Matlab') 
...
aedat.importParams.filePath = 'IMU_rotDisk.aedat'; % Windows
