function [outMetrix2, outCorr2, Assignments, UnassignedTracks, UnassignedDetections] = objectMatch(Location, vSurfGray)
...
[outMetrix2, outCorr2]  = PointsToObject( Location, vSurfGray);
